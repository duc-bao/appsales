...
public class DangKiActivity extends AppCompatActivity {
    ...
    private void dangki() {
        ...
        if(TextUtils.isEmpty(str_email)){
            ...
            if(str_pass.equals(str_repass)){
                // thao tac qua firebase de lay uid user
                firebaseAuth = FirebaseAuth.getInstance();
                firebaseAuth.createUserWithEmailAndPassword(str_email, str_pass).addOnCompleteListener(DangKiActivity.this,
                        new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if(task.isSuccessful()){
                                    ...
                                    Toast.makeText(getApplicationContext(), "Email đã tồn tại hoac ko thanh cong", Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                ...
                .subscribe(
                        userModel -> {
                            ...
                            if(userModel.isSuccess()){
                                // Hienej thi email, pass vao phan dang nhap
    ...
    private void initView() {
        // lien ket taoj moi API
        apiBanHang = RextrofixClient.getInstance(Utils.Base_URL).create(ApiBanHang.class);
        email = findViewById(R.id.txtemaildangki);
        pass = findViewById(R.id.txtpassworddangki);
        repass = findViewById(R.id.txtpassresetdangki);
        mobile = findViewById(R.id.mobliedangki);
